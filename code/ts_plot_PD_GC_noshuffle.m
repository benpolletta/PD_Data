function ts_plot_PD_GC_noshuffle(epoch_length, freq_lim)
...
for fo = 2:length(folders)
    ...
    for b = 1:no_bands
        ...
        save([obs_name(1:end-4),'_',f_lim_label{b},'_ts_noshuffle'],'Bandwise_GC_spec')
        
    end
    
    save_as_pdf(gcf,[obs_name(1:end-4),'_',all_f_lim_label,'_ts_noshuffle'])
