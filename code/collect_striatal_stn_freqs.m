function collect_striatal_stn_freqs(time_window, percent, norm, band_index, freqs, no_cycles, bands)
...
channels = [2 1; 1 2]; no_chans = size(channels, 2);
...
for pd = 1:no_pds
    ...
    for ch = 1:no_chans
        ...
        fid(pd, ch) = fopen(['STR_STN', BP_suffix, '_2sd_', short_band_labels{band_index}, '_high_',...
