function collect_control_opto_nm3_spectrum(peak_suffix, norm_for_power, band_index, freqs, no_cycles, bands)
...
subject_matnames = {'st_m1_ali_control_opto_no_mice3', 'st_m1_ali2_control_opto', 'st_m1_ali3_control_opto'};
