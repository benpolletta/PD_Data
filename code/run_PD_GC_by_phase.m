...
%     cd (folder)
    ...
    master_listname = [folder,'/',folder,'_all_channel_data_dec_phase_master.list'];
    ...
    for l = 1:no_lists
        ...
        epoch_list = text_read([folder,'/',listname],'%s%*[^\n]');
...
%             epoch_name = epoch_name(8:end);
        ...
        save([folder,'/',listname(1:end-5),'_GC.mat'],'Orders','Errors','All_GC','All_pval','All_sig')
