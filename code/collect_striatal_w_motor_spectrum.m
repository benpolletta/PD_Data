function collect_striatal_w_motor_spectrum(peak_suffix, epoch_secs, norm_for_power, band_index, freqs, no_cycles, bands)
...
save(['STR_w_M1', BP_suffix, '_pct_', short_band_labels{band_index}, '_high_',...
