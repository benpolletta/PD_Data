function PD_beta_blocks_rel_infusion_pre_post_stats(subject_mat, epoch_secs)
...
for b = 1:no_bands
    ...
    save_as_pdf(b, [subject_mat(1:(end - length('_subjects.mat'))), '_pct_BP_high_', num2str(epoch_secs/60), '_min_', short_band_labels{b}])
