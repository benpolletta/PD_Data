function PD_beta_epochs_coh_collect(subjects_mat, outlier_lim, sd_lim, win_size, smooth_size)
...
for ch = 1:no_channels
    ...
    for pd = 1:2
        ...
        for fo = 1:length(folders)
            ...
            load([beta_listname(1:end-5),'_coh.mat'])
