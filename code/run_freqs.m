...
for k = 1:length(freqs)
    ...
    for i = 1:length(subject_matnames)
        ...
        for j = 1:length(norms)
            ...
            beta_blocks_rel_infusion_freqs([subject_matnames{i}, '_subjects.mat'], norms{j}, band_indices(k), freqs{k}, no_cycles{k}, bands{k})
            
            beta_blocks_rel_infusion_freq_plot([subject_matnames{i}, '_subjects.mat'], norms{j}, '', band_indices(k), freqs{k}, no_cycles{k}, bands{k})
