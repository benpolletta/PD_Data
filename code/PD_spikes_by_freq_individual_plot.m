function PD_spikes_by_freq_individual_plot(folder, prefix, basetime, spike_boundaries, band, band_label, no_cycles, min_secs_apart, min_prominences, min_prominences_flag, plot_opt)
