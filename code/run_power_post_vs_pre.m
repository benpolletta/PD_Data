function increase_summary = run_power_post_vs_pre(subject_mat_cell, save_name, chan_labels, peak_suffix, freqs, no_cycles, bands, band_indices, window_length)
...
power_post_vs_pre_timeseries_data(subject_mat_cell, save_name, peak_suffix,...
    norm, freqs, no_cycles, bands, band_indices, window_length)

power_post_vs_pre_timeseries_plot(save_name, chan_labels, peak_suffix, freqs, no_cycles, bands, band_indices, window_length)
