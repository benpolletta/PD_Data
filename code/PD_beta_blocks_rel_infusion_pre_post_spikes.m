function PD_beta_blocks_rel_infusion_pre_post_spikes(subject_mat, epoch_secs, pd_handle)
...
Spikes_sec = nan(epoch_secs, no_folders, 2, no_bands, 2);
        ...
        for ch = 1:no_chans
            ...
            for pd = 1:no_pds
                ...
                for sec = 1:epoch_secs
                    ...
                    Spikes_sec(sec, fo, pd, b, ch) = nanmean(Spike_indicator(sec_start:sec_end, b, ch));
