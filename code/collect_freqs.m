function collect_freqs(name, subject_matnames, channels, peak_suffix, time_window, percent, norm, band_index, freqs, no_cycles, bands)
...
for pd = 1:no_pds
    ...
    for ch = 1:no_chans
        ...
        fid(pd, ch) = fopen([name, BP_suffix, '_2sd_', short_band_labels{band_index}, '_high_',...
